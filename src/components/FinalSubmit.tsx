...
export default function FinalSubmit() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center p-6">
      {/* Background Image */}
      <img
        src="/frames/profile/welcome.png"
        alt="background"
        className="absolute inset-0 w-full h-full object-cover blur-sm z-0"
      />

      {/* Blue overlay */}
      <div className="absolute inset-0 bg-blue-800 bg-opacity-30 z-10"></div>

      {/* Content Wrapper */}
      <div className="relative z-20 w-full max-w-5xl mx-auto text-center">
        <motion.h1
          className="text-5xl font-extrabold mb-10 text-yellow-300 bg-clip-text text-transparent"
        ...
        <div className="bg-white shadow-2xl rounded-2xl p-8 w-full max-w-3xl mx-auto border-t-8 border-gradient-to-r from-red-500 to-blue-500">
