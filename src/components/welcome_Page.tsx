...
const Welcome_Page: React.FC<WelcomePageProps> = ({ onStart }) => {
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center justify-center text-white p-6 overflow-hidden">
      {/* 👇 Background Image with Blur */}
      <img
        src="/frames/profile/welcome.png" // 👈 yahan apni image ka sahi naam/path daal
        alt="background"
      ...
      {/* 👇 Actual Content (same as before) */}
      <div className="relative z-10 min-h-screen w-full flex flex-col items-center justify-center">
        {/* Title Section */}
        <div className="text-center mb-8">
          <h1
            className="text-yellow-300 text-7xl font-bold mb-3 drop-shadow-7xl"
            style={{
              fontFamily: "DeatheMaach",
              letterSpacing: "2px",
          ...
          style={{
              letterSpacing: "1px", // agar text spacing chahiye
              textShadow: "2px 2px 4px black", // text shadow
            }}
        ...
        <div className="flex flex-col md:flex-row w-full max-w-6xl h-[80vh] gap-6">
          {/* Left: Rules */}
          <div
            className={`flex-1 bg-white bg-opacity-20 backdrop-blur-md p-8 rounded-xl shadow-lg overflow-y-auto transition-opacity duration-1000 ${
              rulesVisible ? "opacity-100" : "opacity-0"
            }`}
            style={{
              letterSpacing: "1px", // agar text spacing chahiye
              textShadow: "2px 2px 4px black", // text shadow
          ...
          >
            ...
            <ol className="list-decimal list-inside space-y-2 text-white text-sm md:text-base drop-shadow-2xl">
              <li>Pre-Selected Referee.</li>
              <li>
                Always press the Reveal button to display the correct answer.
              </li>
              <li>
                The Referee can award themselves points only if all other
                players have answered incorrectly.
              </li>
              <li>Game Changer Round has special points.</li>
              <li>
                In the 5th round of the game, click "Final Submit" to view the
                final scores and claim rewards🎁.
              </li>
            </ol>
          </div>
          ...
          <div
            className="flex-1 flex flex-col items-center justify-center p-8 mt-8 md:mt-0"
            style={{
              letterSpacing: "1px", // agar text spacing chahiye
              textShadow: "2px 2px 4px black", // text shadow
            }}
          >
            <div className="flex flex-col items-center bg-white bg-opacity-10 p-6 rounded-2xl border-4 border-white shadow-2xl gap-4">
              {/* Full Name */}
              <p className="text-2xl font-semibold mb-2 drop-shadow-lg">
                🙌 Give me a huge shout-out! 🎉
              </p>
              <p className="text-2xl font-semibold mb-2 drop-shadow-lg">
                Ranjan Chandravanshi
              </p>
